<div class="vip-domains">
	<div class="top">
		<p>VIP DOMAINS</p>
		<span>Emails from any of these domains will be delivered immediately</span>
	</div>
	<div class="domains">
		<div class="domain">
		...
		<input type="text" name="domain" id="domain" autocomplete="off" placeholder="add domain..." />
	</div>
	<div class="bottom">
		<button>
			<span>SAVE</span>
